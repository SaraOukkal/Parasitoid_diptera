...
--wait-for-files /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.elfvb3g3 /beegfs/data/soukkal/StageM2/Control_genomes/genomes/GCA_917880715.2.fna --latency-wait 5 \
...
--mode 2  && touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.elfvb3g3/67.jobfinished || (touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.elfvb3g3/67.jobfailed; exit 1)
