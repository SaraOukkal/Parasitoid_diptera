...
--wait-for-files /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.kf6p1iwz /beegfs/data/soukkal/StageM2/Control_genomes/genomes/GCF_013340165.1.fna --latency-wait 5 \
...
--mode 2  && touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.kf6p1iwz/77.jobfinished || (touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.kf6p1iwz/77.jobfailed; exit 1)
