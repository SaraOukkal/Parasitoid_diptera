...
--wait-for-files /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.ug3xhi9i /beegfs/data/soukkal/StageM2/Hymenoptera_genomes/genomes/GCA_009823575.1.fna --latency-wait 5 \
...
--mode 2  && touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.ug3xhi9i/4.jobfinished || (touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.ug3xhi9i/4.jobfailed; exit 1)
