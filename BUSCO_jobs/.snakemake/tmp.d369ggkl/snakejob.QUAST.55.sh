#!/bin/sh
# properties = {"type": "single", "rule": "QUAST", "local": false, "input": ["/beegfs/data/soukkal/StageM2/Tachinids_genomes/genomes/hyphantrophaga_wood11.fna"], "output": ["/beegfs/data/soukkal/StageM2/Tachinids_genomes/results/Stat_Results/hyphantrophaga_wood11/QUAST_results/report.tsv"], "wildcards": {"Genome_ID": "hyphantrophaga_wood11"}, "params": {"threads": "5", "time": "00:20:00", "name": "QUAST_run_hyphantrophaga_wood11", "out": "/beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/QUAST_LOGS/QUAST_job_hyphantrophaga_wood11.out", "err": "/beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/QUAST_LOGS/QUAST_job_hyphantrophaga_wood11.error"}, "log": [], "threads": 1, "resources": {}, "jobid": 55, "cluster": {}}
...
--mode 2  && touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.d369ggkl/55.jobfinished || (touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.d369ggkl/55.jobfailed; exit 1)
