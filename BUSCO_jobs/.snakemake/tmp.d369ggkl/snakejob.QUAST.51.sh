#!/bin/sh
# properties = {"type": "single", "rule": "QUAST", "local": false, "input": ["/beegfs/data/soukkal/StageM2/Tachinids_genomes/genomes/houghia_pallida.fna"], "output": ["/beegfs/data/soukkal/StageM2/Tachinids_genomes/results/Stat_Results/houghia_pallida/QUAST_results/report.tsv"], "wildcards": {"Genome_ID": "houghia_pallida"}, "params": {"threads": "5", "time": "00:20:00", "name": "QUAST_run_houghia_pallida", "out": "/beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/QUAST_LOGS/QUAST_job_houghia_pallida.out", "err": "/beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/QUAST_LOGS/QUAST_job_houghia_pallida.error"}, "log": [], "threads": 1, "resources": {}, "jobid": 51, "cluster": {}}
...
--mode 2  && touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.d369ggkl/51.jobfinished || (touch /beegfs/data/soukkal/StageM2/Scripts/BUSCO_jobs/.snakemake/tmp.d369ggkl/51.jobfailed; exit 1)
